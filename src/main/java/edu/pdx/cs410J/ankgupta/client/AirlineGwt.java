...
public class AirlineGwt implements EntryPoint {
    public void onModuleLoad() {
        ...
        form.getElement().getStyle().setBorderStyle(Style.BorderStyle.SOLID);
        layout.getElement().getStyle().setBorderStyle(Style.BorderStyle.SOLID);
            ...
            public void onClick(ClickEvent clickEvent) {
                if (create.getValue() == true) {
                    ...
                    if (addflight == true) {
                        ...
                        async.addFlight(name, flight, new AsyncCallback<HashMap<String, Airline>>() {
                            @Override
                    ...
                    if (searchflight == true) {
                        ...
                        FlightServiceAsync async = GWT.create(FlightService.class);
                        async.searchFlight(name, source, dest, new AsyncCallback<HashMap<String, Airline>>() {
        ...
        display.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent clickEvent) {
                FlightServiceAsync async = GWT.create(FlightService.class);
                async.Display(new AsyncCallback<HashMap<String, Airline>>() {
                    @Override
                    public void onFailure(Throwable throwable) {
                        Window.alert("!!!!!!!!!!!!!" + throwable.toString());
                    }
